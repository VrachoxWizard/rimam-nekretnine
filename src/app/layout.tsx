...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  const business = { '@context': 'https://schema.org', '@type': 'RealEstateAgent', name: 'RIMAM d.o.o.', url: origin, telephone: '+38598250447', email: 'ana-marija@rimam.hr', address: { '@type': 'PostalAddress', streetAddress: 'Trnsko 1b', postalCode: '10000', addressLocality: 'Zagreb', addressCountry: 'HR' } }
