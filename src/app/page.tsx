...
export default async function Home() {
  ...
  return <main id="sadrzaj">
    <section className="hero"><ResponsiveImage src="/optimized/images/hero.webp-1600.webp" alt="Svijetao interijer stana s pogledom na Zagreb, konceptualna fotografija" width={1600} height={1000} loading="eager" fetchPriority="high" sizes="100vw" className="hero-photo" /><div className="hero-shade" /><div className="container hero-inner"><div className="hero-copy"><p className="eyebrow light">RIMAM · Zagreb od 1993.</p><h1>Prostor za<br /><em>prave odluke.</em></h1><p>Pronađite nekretninu koja ima smisla za vaš sljedeći korak.</p><Link className="button button-light" href="/nekretnine/">Istražite nekretnine <span>↗</span></Link></div></div><div className="hero-index">RIMAM / NEKRETNINE</div></section>
    ...
    <section className="editorial-section"><div className="editorial-image"><ResponsiveImage src="/optimized/images/stan-klasika.webp-1600.webp" alt="Svijetao interijer klasičnog gradskog stana, konceptualna fotografija" width={1600} height={1000} loading="lazy" sizes="(max-width: 800px) 100vw, 50vw" /></div><div className="editorial-copy"><span className="accent-line" /><p className="eyebrow">Više od adrese</p><h2>Dom se ne bira samo brojkama.</h2><p>Svaka nekretnina ima svoj karakter. Naš je posao prepoznati što je važno vama, predstaviti prostor pošteno i pomoći da odlučite s povjerenjem.</p><Link className="text-link" href="/usluge/">Kako radimo <span>↗</span></Link></div></section>
