...
export function Footer() {
  return <footer className="site-footer">
    <div className="container footer-top">
      ...
      <div className="footer-contact"><span>Razgovarajmo o vašoj nekretnini.</span><a href="tel:+38598250447">+385 98 250 447</a><a href="mailto:robert.ruzic67@gmail.com">robert.ruzic67@gmail.com</a></div>
    </div>
